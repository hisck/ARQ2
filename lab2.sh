...
SYSCALL="$CAP/gem5/src/arch/x86/linux"
...
simular()
{
    if [ -d "$GEM5" ]; then
        ...
        cd "$GEM5"
		build/x86_MOESI_CMP_directory/gem5.fast ./configs/example/se.py --cpu-type=DerivO3CPU --bp-type=LTAGE -n 16 --cpu-clock=3GHz --mem-size=1GB --caches --l2cache --l1d_size=32kB --l1i_size=32kB --l2_size=256kB --ruby --ruby-clock=3GHz --topology=Mesh_XY --num-dirs=16 --num-l2caches=16 --mesh-rows=4 --network=garnet2.0 --routing-algorithm=1 -c $CAP/gem5/bin/fast -o "--class small --nthreads 16" --output=statsFAST.txt

		build/x86_MOESI_CMP_directory/gem5.fast ./configs/example/se.py --cpu-type=DerivO3CPU --bp-type=LTAGE -n 16 --cpu-clock=3GHz --mem-size=1GB --caches --l2cache --l1d_size=32kB --l1i_size=32kB --l2_size=256kB --ruby --ruby-clock=3GHz --topology=Mesh_XY --num-dirs=16 --num-l2caches=16 --mesh-rows=4 --network=garnet2.0 --routing-algorithm=1 -c $CAP/gem5/bin/fn -o "--class small --nthreads 16" --output=statsFN.txt

		build/x86_MOESI_CMP_directory/gem5.fast ./configs/example/se.py --cpu-type=DerivO3CPU --bp-type=LTAGE -n 16 --cpu-clock=3GHz --mem-size=1GB --caches --l2cache --l1d_size=32kB --l1i_size=32kB --l2_size=256kB --ruby --ruby-clock=3GHz --topology=Mesh_XY --num-dirs=16 --num-l2caches=16 --mesh-rows=4 --network=garnet2.0 --routing-algorithm=1 -c $CAP/gem5/bin/gf -o "--class small --nthreads 16" --output=statsGF.txt

		build/x86_MOESI_CMP_directory/gem5.fast ./configs/example/se.py --cpu-type=DerivO3CPU --bp-type=LTAGE -n 16 --cpu-clock=3GHz --mem-size=1GB --caches --l2cache --l1d_size=32kB --l1i_size=32kB --l2_size=256kB --ruby --ruby-clock=3GHz --topology=Mesh_XY --num-dirs=16 --num-l2caches=16 --mesh-rows=4 --network=garnet2.0 --routing-algorithm=1 -c $CAP/gem5/bin/is -o "--class small --nthreads 16" --output=statsIS.txt

		build/x86_MOESI_CMP_directory/gem5.fast ./configs/example/se.py --cpu-type=DerivO3CPU --bp-type=LTAGE -n 16 --cpu-clock=3GHz --mem-size=1GB --caches --l2cache --l1d_size=32kB --l1i_size=32kB --l2_size=256kB --ruby --ruby-clock=3GHz --topology=Mesh_XY --num-dirs=16 --num-l2caches=16 --mesh-rows=4 --network=garnet2.0 --routing-algorithm=1 -c $CAP/gem5/bin/km -o "--class small --nthreads 16" --output=statsKM.txt

		build/x86_MOESI_CMP_directory/gem5.fast ./configs/example/se.py --cpu-type=DerivO3CPU --bp-type=LTAGE -n 16 --cpu-clock=3GHz --mem-size=1GB --caches --l2cache --l1d_size=32kB --l1i_size=32kB --l2_size=256kB --ruby --ruby-clock=3GHz --topology=Mesh_XY --num-dirs=16 --num-l2caches=16 --mesh-rows=4 --network=garnet2.0 --routing-algorithm=1 -c $CAP/gem5/bin/lu -o "--class small --nthreads 16" --output=statsLU.txt

		build/x86_MOESI_CMP_directory/gem5.fast ./configs/example/se.py --cpu-type=DerivO3CPU --bp-type=LTAGE -n 16 --cpu-clock=3GHz --mem-size=1GB --caches --l2cache --l1d_size=32kB --l1i_size=32kB --l2_size=256kB --ruby --ruby-clock=3GHz --topology=Mesh_XY --num-dirs=16 --num-l2caches=16 --mesh-rows=4 --network=garnet2.0 --routing-algorithm=1 -c $CAP/gem5/bin/tsp -o "--class small --nthreads 15" --output=statsTSP.txt
